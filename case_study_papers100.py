...
if __name__ == '__main__':
    ...
    origin = sys.stdout
    f = open('papers100_case_study_degree3.txt', 'w')
    sys.stdout = f
    ...
    all_sm_vectors = np.load('output/{}_all_sm_vectors.npy'.format(dataname))
    ...
    with open('./output/oldy2newy', 'rb') as file:
        oldy2newy = pickle.load(file)
    with open('./output/idx2ogbidx', 'rb') as file:
